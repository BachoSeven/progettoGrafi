...
- ~~Pareva che #{archi} fosse approssimativamente 8 milioni, ovvero #{Film}, ma ogni film crea potenzialmente binom(#{attoripresentinelfilm},2) archi(se non ridondanti), per cui dovrebbe essere un bel po' più alto(anche se come ordine di grandezza potrebbe starci in effetti...)~~
- ~~[ ] multi-threading ~~
